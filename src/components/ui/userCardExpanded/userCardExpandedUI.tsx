...
import type { TUserCardUIProps, TSubcategoryWantToLearn } from "../userCard/type";
...
export const UserCardExpandedUI: FC<TUserCardUIProps> = ({
  person,
  isLiked,
  onLikeToggle,
  onShareToggle,
      ...
      {/* === Секция профиля === */}
        ...
        {/* === Секция навыка + галереи === */}
          ...
          <img
            ...
            alt={`${person.name} image ${selectedIndex + 1}`}
          />
          <button
            className={style.galleryNav}
            onClick={showNext}
